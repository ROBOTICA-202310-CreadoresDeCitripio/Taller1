...
#include "turtle_bot_servcli/srv/detail/move_robot__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtle_bot_servcli::srv::MoveRobot_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_bot_servcli::srv::MoveRobot_Request & ros_message)
{
  // Member: position_start
...
{
  auto typed_message =
    static_cast<const turtle_bot_servcli::srv::MoveRobot_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_bot_servcli::srv::MoveRobot_Request *>(
    untyped_ros_message);
...
{
  return &turtle_bot_servcli::srv::typesupport_fastrtps_cpp::_MoveRobot_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_bot_servcli, srv, MoveRobot_Request)() {
  return &turtle_bot_servcli::srv::typesupport_fastrtps_cpp::_MoveRobot_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtle_bot_servcli
cdr_serialize(
  const turtle_bot_servcli::srv::MoveRobot_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_bot_servcli::srv::MoveRobot_Response & ros_message)
{
  // Member: position_destiny
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
...
{
  auto typed_message =
    static_cast<const turtle_bot_servcli::srv::MoveRobot_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<turtle_bot_servcli::srv::MoveRobot_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &turtle_bot_servcli::srv::typesupport_fastrtps_cpp::_MoveRobot_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_bot_servcli, srv, MoveRobot_Response)() {
  return &turtle_bot_servcli::srv::typesupport_fastrtps_cpp::_MoveRobot_Response__handle;
}
...
{
  return &turtle_bot_servcli::srv::typesupport_fastrtps_cpp::_MoveRobot__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_bot_servcli, srv, MoveRobot)() {
  return &turtle_bot_servcli::srv::typesupport_fastrtps_cpp::_MoveRobot__handle;
}
