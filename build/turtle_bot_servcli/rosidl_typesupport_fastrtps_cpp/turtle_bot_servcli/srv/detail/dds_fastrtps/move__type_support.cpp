...
#include "turtle_bot_servcli/srv/detail/move__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const turtle_bot_servcli::srv::Move_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_bot_servcli::srv::Move_Request *>(
    untyped_ros_message);
...
{
  return &turtle_bot_servcli::srv::typesupport_fastrtps_cpp::_Move_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const turtle_bot_servcli::srv::Move_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<turtle_bot_servcli::srv::Move_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &turtle_bot_servcli::srv::typesupport_fastrtps_cpp::_Move_Response__handle;
}
...
{
  return &turtle_bot_servcli::srv::typesupport_fastrtps_cpp::_Move__handle;
}
