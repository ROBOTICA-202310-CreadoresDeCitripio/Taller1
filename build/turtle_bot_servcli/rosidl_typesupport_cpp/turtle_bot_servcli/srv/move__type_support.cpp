...
static const _Move_Request_type_support_symbol_names_t _Move_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_bot_servcli, srv, Move_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtle_bot_servcli, srv, Move_Request)),
  }
};
...
{
  return &::turtle_bot_servcli::srv::rosidl_typesupport_cpp::Move_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtle_bot_servcli, srv, Move_Request)() {
  return get_message_type_support_handle<turtle_bot_servcli::srv::Move_Request>();
}
...
static const _Move_Response_type_support_symbol_names_t _Move_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_bot_servcli, srv, Move_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtle_bot_servcli, srv, Move_Response)),
  }
};
...
{
  return &::turtle_bot_servcli::srv::rosidl_typesupport_cpp::Move_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtle_bot_servcli, srv, Move_Response)() {
  return get_message_type_support_handle<turtle_bot_servcli::srv::Move_Response>();
}
...
static const _Move_type_support_symbol_names_t _Move_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_bot_servcli, srv, Move)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtle_bot_servcli, srv, Move)),
  }
};
...
{
  return &::turtle_bot_servcli::srv::rosidl_typesupport_cpp::Move_service_type_support_handle;
}
