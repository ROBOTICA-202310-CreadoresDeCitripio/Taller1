...
class Metaclass_Move(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from turtle_bot_servcli.srv import _move
...
class Move(metaclass=Metaclass_Move):
    from turtle_bot_servcli.srv._move import Move_Request as Request
    from turtle_bot_servcli.srv._move import Move_Response as Response
