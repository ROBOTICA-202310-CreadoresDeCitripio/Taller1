...
class Metaclass_MoveRobot(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'turtle_bot_servcli.srv.MoveRobot')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from turtle_bot_servcli.srv import _move_robot
...
class MoveRobot(metaclass=Metaclass_MoveRobot):
    from turtle_bot_servcli.srv._move_robot import MoveRobot_Request as Request
    from turtle_bot_servcli.srv._move_robot import MoveRobot_Response as Response
